...
/// @nodoc
@JsonSerializable()
class _$_Eng implements _Eng {
  _$_Eng({this.official, this.common});
  ...
  @override
  String toString() {
    return 'Eng(official: $official, common: $common)';
  }
...
abstract class _Eng implements Eng {
  factory _Eng({final String? official, final String? common}) = _$_Eng;
